...
module.exports = function (app) {
    ...
    * */
    app.get('/api/service/list', app.controller.service.list);
    /**
     * @api { POST } /api/service/list 服务器列表
     * @apiVersion 1.0.0
     * @apiParam {number} page 分页码 >= 1
     ...
     * @apiSampleRequest /api/service/list
     * */
    app.get('/api/service/service_by_id', app.controller.service.service_by_id);
    /**
    ...
    * */
    app.post('/api/service/operate', app.controller.service.operate);
};
